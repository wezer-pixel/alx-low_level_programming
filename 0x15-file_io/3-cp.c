...
/**
 * check97 - check for the number of arguments
...
/**
 * check98 - check that file_from exist with read permissions
 * @check: true of false
 * @file: file_from name
...
/**
 * check99 - checks that file_to exist and/or has write permissions
 * @check: checks true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
 *
...
/**
 * check100 - check file descriptors were closing
 * @check: check
 * @fd: file descriptor
 *
 * Return: void
